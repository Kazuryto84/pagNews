...
const SendForm = ({formValues = defaultFormFields, sendAction = addStoryAsync}) => {
  ...
  // Asegúrate de que currentUser no es nulo antes de acceder a sus propiedades
  const userData = currentUser ? { user: currentUser.displayName, user_id: currentUser.uid } : { user: '', user_id: '' };
  ...
  }, [storyError, currentUser, navigate]);
